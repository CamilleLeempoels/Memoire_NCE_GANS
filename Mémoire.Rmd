...
# Fonction objectif
L = function(alpha){ return(sum(log(pm_barre_ising(y,psi)/pm_barre_ising(y,alpha))) - m*log(mean(pm_barre_ising(x,psi)/pm_barre_ising(x,alpha))))}
